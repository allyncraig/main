...
class DailyReadingManager {
	constructor(storageManager, readingPlanStore, navigationManager) {
	...
	async initialize() {
		...
		this.readingPlan = this.readingPlanStore.getReadingPlan();
	...
	saveState() {
		this.readingPlanStore.setDailyReadingProgress(
	...
	loadState() {
		const saved = this.readingPlanStore.getDailyReadingProgress();
